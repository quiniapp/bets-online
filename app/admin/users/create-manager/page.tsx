        ...
        <div className="space-y-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-muted-foreground">Registra un nuevo gerente con permisos administrativos</p>
            </div>
          </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-yellow-700 dark:text-yellow-300 mt-1">
                    Los gerentes tendrán acceso a funciones administrativas sensibles. Asegúrate de otorgar solo los
                    permisos necesarios.
                  </p>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Datos principales del gerente</CardDescription>
                </CardHeader>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Selecciona los permisos que tendrá este gerente</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
